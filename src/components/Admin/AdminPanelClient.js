      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex space-x-4 mb-8">
          <button
            ...
            className={`px-4 py-2 rounded-lg ${activeTab === 'images' ? 'bg-pink-600 text-white' : 'bg-white text-gray-700'}`}
          >
            Manage Images
          </button>
          <button
            onClick={() => setActiveTab('videos')}
            className={`px-4 py-2 rounded-lg ${activeTab === 'videos' ? 'bg-pink-600 text-white' : 'bg-white text-gray-700'}`}
          >
            Manage Videos
          </button>
          <button
            onClick={() => setActiveTab('notes')}
            className={`px-4 py-2 rounded-lg ${activeTab === 'notes' ? 'bg-pink-600 text-white' : 'bg-white text-gray-700'}`}
          >
            Manage Notes
          </button>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg">
          ...
          {activeTab === 'images' && (
            <div className="p-6">
              ...
              <h3 className="text-xl font-semibold mb-4">Current Images ({images.length})</h3>
              {images.length === 0 ? (
          ...
          {activeTab === 'notes' && (
            <div className="p-6">
              ...
              <h3 className="text-xl font-semibold mb-4">Current Notes ({notes.length})</h3>
              {notes.length === 0 ? (
